<form action="{{route('consumers.update',$consumer->id)}}" method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Mr., Mrs." value="{{old('salutation',$consumer->salutation)}}" name="salutation">
            </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <input type="text" class="form-control" value="{{old('primary_email',$consumer->primary_email)}}" placeholder="xyz@example.com" name="primary_email">
            </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <input type="text" class="form-control" value="{{old('current_us_address_2',$consumer->current_us_address_2)}}" placeholder="Address" name="current_us_address_2">
            </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <div class="form-group">
                <input type="text" class="form-control" value="{{old('current_us_lived_for_more_than_two_years',$consumer->current_us_lived_for_more_than_two_years)}}" placeholder="" name="current_us_lived_for_more_than_two_years">
            </div>
        </div>
    </div>
    <button  class="btn btn-primary">Update and Next</button>
</form>
