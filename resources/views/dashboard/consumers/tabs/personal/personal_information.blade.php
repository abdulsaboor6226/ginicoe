<form action="{{route('consumers.update',$consumer->id)}}" method="POST">
    ...
    <input type="hidden" name="sub_tab" value="primary_info">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <input type="number" class="form-control" value="{{old('primary_phone',$consumer->primary_phone)}}" placeholder="123456789" required name="primary_phone">
            </div>
        </div>
        <label class="col-sm-2 form-control-label">Current US Urbanization Name </label>
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control" value="{{old('current_us_urbanization_name',$consumer->current_us_urbanization_name)}}" placeholder="xyz.." required name="current_us_urbanization_name">
            </div>
        </div>
    </div>
    <div class="form-group row">
