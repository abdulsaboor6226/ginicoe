            ...
            @if (@Auth::user()->permissions_id == 3)
                <div class="col-sm-8">
                    <div class="alert alert-warning" role="alert">
                        <h4> <i class="fas-info-circle"></i> Your <b> Become a {{ @Auth::user()->requestForRole }} </b>
                            request has been registered </h4>
                    </div>
                </div>
            @endif
            {{--            @endif --}}
                                            ...
                                            @foreach ($Contacts as $Contact)
                                                <li class="list-item">
                                                    ...
                                                    <div class="list-body">
                                                        <div>
                                                            <a
                                                                href="{{ route('contactsEdit', ['id' => $Contact->id]) }}">{{ $Contact->first_name }}
                                                                {{ $Contact->last_name }}</a>
                                                        </div>
...
@else
                            ...
                            <div class="box p-a">
                                <div class="pull-left m-r">
                                    <span class="w-48  accent">
                                        <i
                                            class="w-70 r-2x _600 text-lg accent">{{ substr($value->type_of_breach, 0, 1) }}</i>
                                    </span>
                                </div>
                                <div class="clear">
                                    <h4 class="m-a-0 text-lg _300">{{ $value->total_breach }} <strong
                                            class="text-md">{{ $value->type_of_breach }}</strong></h4>
    ...
    @if (@Auth::user()->permissionsGroup->name == 'Consumer')
        @include('dashboard.cards.consumer')
    @endif
    @if (@Auth::user()->permissionsGroup->name == 'Merchent')
        @include('dashboard.cards.merchent')
    @endif
    @if (@Auth::user()->permissionsGroup->name == 'Bank')
        @include('dashboard.cards.bank')
    @endif
    @if (@Auth::user()->permissionsGroup->name == 'Govt')
        @include('dashboard.cards.govt')
    @endif
    @if (@Auth::user()->permissionsGroup->name == 'Healthcare')
        @include('dashboard.cards.healthcare')
    @endif
    @if (@Auth::user()->permissionsGroup->name == 'Education')
    @include('dashboard.cards.education')
@endif
@endsection
