...
@section('content')
    <div class="padding p-b-0">
        ...
        <div class="padding">
            <div class="box">
                <div class="box-body">
                    <form action="{{route('govt.update',$govt->id)}}" method="POST">
                        @csrf
                        @method('put')
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('f_name',$govt->f_name)}}" placeholder="xyz.." required name="f_name">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Last Name <span class="text-danger">*</span> </label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('l_name',$govt->l_name)}}" placeholder="xyz.." required name="l_name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="phone" class="form-control" value="{{old('phone_no',$govt->phone_no)}}" placeholder="xyz..." name="phone_no">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Secondary Phone No<span class="text-danger">*</span> </label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="phone" class="form-control" value="{{old('s_phone_no',$govt->s_phone_no)}}" placeholder="xyz" required name="s_phone_no">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="title">
                                        ...
                                        @foreach($titles as $key=> $value)
                                            <option {{$key == $govt->title ? 'selected' : ""}} value="{{$key}}">{{ucfirst($value)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('building_number',$govt->building_number)}}" placeholder="xyz@example.com" required name="building_number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" value="{{old('street_name',$govt->street_name)}}" placeholder="A/W " required name="street_name">
                            </div>
                            <label class="col-sm-2 form-control-label">Urbanization Number</label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('urbanization_number',$govt->urbanization_number)}}" placeholder="xyz@example.com" name="urbanization_number">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <select id="govt_country" class="form-control" required  name="country_id_fk">
                                        ...
                                        @foreach($countries as $country)
                                            <option {{$country->id == $govt->country_id_fk ? 'selected' : ""}} value="{{$country->id}}">{{$country->name}} - {{$country->iso3}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        @foreach($agencyType as $key =>$value)
                                            @foreach($govt->agency_type as $agencyTypeKey => $agencyTypeValue)
                                                <label class="ui-check p-r-1">
                                                    <input {{$key== $agencyTypeValue ? 'checked' : ""}} type="checkbox" name="agency_type[]" value="{{$key}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="xyz" value="{{old('zip_code',$govt->zip_code)}}" name="zip_code">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="agency_sector_id_fk">
                                        ...
                                        @foreach($govtAgencySector as $key=> $value)
                                            <option {{$key== $govt->agency_sector_id_fk ? 'selected' : ""}} required value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4" style="padding-top: 10px">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="xyz" value="{{old('agency_represent',$govt->agency_represent)}}" name="agency_represent">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4" style="padding-top: 10px">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="budgeting_authority" {{old('budgeting_authority',$govt->budgeting_authority)?'checked':''}} required value="1"> Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="budgeting_authority" {{old('budgeting_authority',$govt->budgeting_authority)?'':'checked'}} required value="0">No
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="amount_of_budgeting">
                                        ...
                                        @foreach($govtBudgetAmount as $key=> $value)
                                            <option {{$key== $govt->amount_of_budgeting ? 'selected' : ""}} required value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <textarea id="textarea" rows="3" cols="37" name="how_ginicoe_help_you" maxlength="1000" >{{$govt->how_ginicoe_help_you}}</textarea>
