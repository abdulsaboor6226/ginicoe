...
@section('content')
    <div class="padding p-b-0">
        <h3 class="text-primary">Update Bank Detail</h3>
        <div class="padding">
            <div class="box">
                <div class="box-body">
                    <form action="{{route('bank.update',$bank->id)}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('financial_institution_title',$bank->financial_institution_title)}}" placeholder="xyz.." required name="financial_institution_title">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">First Name <span class="text-danger">*</span> </label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('f_name',$bank->f_name)}}" placeholder="xyz.." required name="f_name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('m_name',$bank->m_name)}}" placeholder="xyz..." name="m_name">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Last Name<span class="text-danger">*</span> </label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('l_name',$bank->l_name)}}" placeholder="xyz" required name="l_name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="tel" class="form-control" placeholder="xyz" value="{{old('phone_no',$bank->phone_no)}}"  required name="phone_no">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Email<span class="text-danger">*</span> </label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="email" class="form-control" value="{{old('email',$bank->email)}}" placeholder="xyz@example.com" required name="email">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="job_title">
                                        ...
                                        @foreach($jobTitles as $key=> $value)
                                            <option {{$key == $bank->job_title ? 'selected' : ""}} value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="email" class="form-control" value="{{old('secondary_f_name',$bank->secondary_f_name)}}" placeholder="xyz@example.com" name="secondary_f_name">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Address" value="{{old('secondary_l_name',$bank->secondary_l_name)}}" name="secondary_l_name">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Secondary Phone</label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="tel" class="form-control" placeholder="Address" value="{{old('secondary_phone_no',$bank->secondary_phone_no)}}"  name="secondary_phone_no">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="tel" class="form-control" value="{{old('secondary_fax_no',$bank->secondary_fax_no)}}" placeholder="London" name="secondary_fax_no">
                                </div>
                            </div>
                            <label class="col-sm-2 form-control-label">Secondary Email</label>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="xyz" value="{{old('secondary_email',$bank->secondary_email)}}" name="secondary_email">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                    ...
                                    <select id="single-append-radio" class="form-control select2-allow-clear" required multiple ui-jp="select2" name="financial_institution_represent[]" ui-options="{theme: 'bootstrap'}">
                                        <optgroup label="Select Multi Option">
                                            @foreach($FI_represents as $key =>$value)
                                                @foreach($bank->financial_institution_represent as $representKey => $representValue)
                                                    <option {{$key == $representValue ? 'selected' : ""}} value="{{$representKey}}">{{$value}}</option>
                                                @endforeach
                                            @endforeach
                                        </optgroup>
                                    </select>
                                ...
                                <div class="form-group">
                                    @foreach($FI_charterTypes as $key=> $value)
                                        <label class="radio-inline">
                                            <input type="radio" name="FI_type" {{old('FI_type',$bank->FI_type)?'checked':''}} required value="{{$key}}"> {{$value}}
                                        </label>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4" style="padding-top: 10px">
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="FI_operate_across_state" {{old('FI_operate_across_state',$bank->FI_operate_across_state)?'checked':''}} required value="1"> Yes
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="FI_operate_across_state" {{old('FI_operate_across_state',$bank->FI_operate_across_state)?'':'checked'}} required value="0">No
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="asset_size">
                                        ...
                                        @foreach($assetSizes as $key=> $value)
                                            <option {{$key == $bank->asset_size ? 'selected' : ""}} value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                                    ...
                                    <select id="single-append-radio" class="form-control select2-allow-clear" name="FI_performs[]" required multiple ui-jp="select2" ui-options="{theme: 'bootstrap'}">
                                        <optgroup label="Select Multi Option">
                                            @foreach($FI_performses as $key =>$value)
                                                @foreach($bank->FI_performs as $performsKey => $performsValue)
                                                    <option {{$key == $performsValue ? 'selected' : ""}} value="{{$performsKey}}">{{$value}}</option>
                                                @endforeach
                                            @endforeach
                                        </optgroup>
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="xyz" value="{{old('BIN',$bank->BIN)}}"  required name="BIN">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <select class="form-control" required  name="daily_trade">
                                        ...
                                        @foreach($dailyTrades as $key=> $value)
                                            <option {{$key == $bank->daily_trade ? 'selected' : ""}} value="{{$key}}">{{$value}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('portfolio_size',$bank->portfolio_size)}}" placeholder="12345" required name="portfolio_size">
                                </div>
                            </div>
                        </div>
