                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0">
                        ...
                        <tr>
                            ...
                            <th>{{ __('backend.request_permission') }}</th>
                        ...
                        @foreach($Users as $User)
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="modal" data-target="#m-md"><img src="{{ Helper::getImage($User->doc_photo_url) }}" width="50%"></a>
                                ...
                                <td>
                                    <small>{{ ucfirst(@$User->requestForRole)}}</small>
                                </td>
